    ...
    @foreach ($diagnosticos as $diagnostico)
        <tr>
            ...
            <td>
                ...
                <a href="{{route('diagnostico.show', $diagnostico->id)}}" class="btn btn-link"><span class="oi oi-eye"></span></a>
                <a href="{{route('diagnostico.edit', $diagnostico->id)}} " class="btn btn-link"><span class="oi oi-pencil"></span></a>
                @csrf
                @method('DELETE')
